...
import type { Project, PageMeta } from '../types';
...
export function WorkGrid({ projects, meta }: { projects: Project[]; meta: PageMeta | null }) {
  const activeMeta = meta || DEFAULT_META;
    ...
    <div className="w-full px-4 md:px-12 pt-16 md:pt-32 min-h-screen">
      ...
      <div className="sticky top-4 md:top-6 z-30 mb-8 md:mb-24">
        <div className="glass-panel rounded-full p-2 flex flex-col md:flex-row justify-between items-center gap-3 bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl">
          <div className="pl-6 pr-4 md:whitespace-nowrap">
            <h1 className="font-serif text-xl text-white tracking-wide sr-only md:not-sr-only">{activeMeta.title}</h1>
          </div>
                        ...
                        <div className="relative overflow-hidden rounded-sm bg-neutral-900 transition-transform duration-700 hover:-translate-y-1">
                          <div className="relative">
                            <Image
                              ...
                              width={project.thumbnail.width || 800}
          ...
          {filteredProjects.length === 0 && (
            ...
            >
              ...
              <p className="font-mono text-xs uppercase tracking-widest">
                {selectedYear ? `No archives found in ${selectedYear}.` : projects.length === 0 ? 'The archive is empty. Check back soon.' : 'No archives found.'}
              </p>
              {selectedYear && (
